const [
  ...
  ({ default: Chart }) => {
    ...
    const entityCommentsChart = new Chart(commentsCanvas, {
      type: 'line',
      data: {
    ...
    return [entityReactionsChart, entityCommentsChart];
  },
);

export { reactionsChart, commentsChart };
